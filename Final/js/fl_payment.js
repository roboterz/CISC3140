...
window.addEventListener("load", function(){
	...
	document.forms.order.elements.game1name.value = orderFields[3];
	document.forms.order.elements.game1Qty.value = orderFields[5];
	document.forms.order.elements.order1Cost.value = orderFields[7];
	document.forms.order.elements.game2name.value = orderFields[11];
	document.forms.order.elements.game2Qty.value = orderFields[13];
	document.forms.order.elements.order2Cost.value = orderFields[15];
	document.forms.order.elements.game3name.value = orderFields[19];
	document.forms.order.elements.game3Qty.value = orderFields[21];
	document.forms.order.elements.order3Cost.value = orderFields[23];
	document.forms.order.elements.game4name.value = orderFields[27];
	document.forms.order.elements.game4Qty.value = orderFields[29];
    document.forms.order.elements.order4Cost.value = orderFields[31];

    document.forms.order.elements.subTotal.value = orderFields[33];
    document.forms.order.elements.salesTax.value = orderFields[35];
    document.forms.order.elements.cartTotal.value = orderFields[37];
});
